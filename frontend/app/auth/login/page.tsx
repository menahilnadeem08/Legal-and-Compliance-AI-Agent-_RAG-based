      ...
      <div className="w-full max-w-md">
        ...
        <div className="glass-border rounded-2xl p-8">
          ...
          <div className="text-center mb-8">
            ...
            <p className="text-gray-400">Sign in with Google to access the admin panel</p>
          </div>
          ...
          <button
            ...
            disabled={loading}
            className="w-full flex items-center justify-center gap-3 px-6 py-3 bg-gradient-to-r from-blue-600 to-blue-700 hover:from-blue-700 hover:to-blue-800 disabled:opacity-50 disabled:cursor-not-allowed text-white font-semibold rounded-lg transition-all duration-200 shadow-lg hover:shadow-blue-500/50 mb-4"
          >
          ...
          <div className="mt-6 p-4 bg-blue-500/10 border border-blue-500/30 rounded-lg">
            <p className="text-sm text-blue-300">
              💡 <strong>Authentication:</strong> Use your Google account to sign in as an admin.
            </p>
          </div>
        </div>
